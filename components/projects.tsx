  ...
  return (
    <section id="projects" className="relative border-t border-border py-32">
      <div className="relative mx-auto max-w-6xl px-6">
        ...
        {/* ── Tier 1: InariWatch ── */}
        <div className="relative mt-8 border-2 border-primary/20 bg-gradient-to-b from-primary/[0.03] to-transparent">
          <div className="absolute -top-3 left-8 bg-background px-3 md:left-12">
            <span className="font-mono text-[10px] uppercase tracking-widest text-primary">
              {dict.projects.inariProduct}
            </span>
          </div>
          <div className="p-8 pt-10 md:p-12 md:pt-12">
            <div className="flex items-center gap-4">
            ...
            <p className="mt-4 max-w-2xl text-base leading-relaxed text-muted-foreground">
              {dict.projects.inariDescription}
            </p>

            {/* Key numbers */}
            <div className="mt-8 flex flex-wrap gap-8">
              {[
                { value: "6+", label: dict.projects.integrations },
                { value: "5", label: dict.projects.safetyGates },
                { value: "3", label: dict.projects.fixRetries },
              ].map((stat) => (
                <div key={stat.label} className="flex flex-col">
                  <span className="font-mono text-2xl font-bold text-primary">
                    {stat.value}
            ...
            <div className="mt-8 flex flex-wrap items-center gap-4">
              <a
                href="https://www.inariwatch.com"
                target="_blank"
                rel="noopener noreferrer"
                className="group inline-flex items-center gap-2 bg-primary px-5 py-2.5 text-sm font-medium text-primary-foreground transition-all hover:opacity-90"
              >
                {dict.projects.exploreInari}
                <svg
                  className="h-4 w-4 transition-transform group-hover:translate-x-1"
                  fill="none"
                  viewBox="0 0 24 24"
